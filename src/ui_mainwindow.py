...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labVersion = QLabel(self.frame_bas)
        self.labVersion.setObjectName(u"labVersion")
        self.labVersion.setMinimumSize(QSize(0, 0))
        self.labVersion.setMaximumSize(QSize(16777215, 16777215))
        self.labVersion.setAutoFillBackground(False)

        self.gridLayout_2.addWidget(self.labVersion, 0, 0, 1, 1)
